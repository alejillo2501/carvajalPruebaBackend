...
import io.example.domain.dto.ResetPassword;
...
public class UserAdminApi {
  ...
  @PutMapping("/reset/{id}")
  public UserView reset(@PathVariable String id, @RequestBody @Valid ResetPassword request) {
    return userService.resetPassword(new ObjectId(id), request);
  }
