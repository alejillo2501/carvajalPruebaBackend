...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    ...
    http.authorizeRequests()
        ...
        .permitAll()
        .antMatchers(HttpMethod.GET, "/api/publicacion/**")
        .permitAll()
        .antMatchers(HttpMethod.POST, "/api/publicacion/search")
        .permitAll()
        .antMatchers(HttpMethod.GET, "/api/comentario/**")
        .permitAll()
        .antMatchers(HttpMethod.POST, "/api/comentario/search")
        .permitAll()
